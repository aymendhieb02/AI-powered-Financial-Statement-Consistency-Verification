  ...
  return (
    <section className="space-y-6">
      <PageHeader
        ...
        description="Execute the full deterministic pipeline and generate accountant-facing reports without leaving the workspace."
        actions={<Button disabled={running} onClick={run}>{running ? <RotateCw size={15} className="animate-spin" /> : <Play size={15} />} Run Verification</Button>}
      />
